$(console.log('"Refresh Jika Error" = \"' + 'FauzanTheme"'));
// navbar menu smartphone
...
function launch_toast() {
    ...
    var myElement = document.getElementById("desc").innerHTML = "TERIMA KASIH";
}


// manipulasi Image atau lazylaod image

(function (a) {
    a.fn.DOM_image = function (b) {
        var c = {
            threshold: 0,
            failurelimit: 0,
            event: "scroll",
...
$(function () {
    // mengamberikan effect loading saat scroll untuk melihat gamabar
    // manipulasi gambar dengan code html <img untuk meringankan beban gambar
    $("img").DOM_image({
